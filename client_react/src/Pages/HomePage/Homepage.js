...
class Homepage extends Component {
    ...
    render() {
        ...
        if (this.props.Courses.length > 0) {
            ...
            } else if (this.state.CourseLink==="preferences") // this is the preference link
            ...
            data = (
                CourseArray.map( item => {
                    ...
                    return (
                        <NavLink
                            className="productLink" key={item._id}
                ...
                <div className="container">
                    <nav aria-label="breadcrumb">
                        <ol className="breadcrumb">
                            ...
                            <li className="breadcrumb-item">
                                <NavLink to={`/Home/${this.state.CourseLink}`}activeStyle={{textDecoration:'underline'}}>
